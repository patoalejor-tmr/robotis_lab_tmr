...
class PickPlaceFFWBG2MimicEnv(ManagerBasedRLMimicEnv):
    """
    Isaac Lab Mimic environment wrapper class for FFW BG2 Pick and Place env.
    """
    ...
    def target_eef_pose_to_action(
        ...
        if action_noise_dict is not None:
            noise = action_noise_dict["ffw_bg2"] * torch.randn_like(pose_action)
            pose_action += noise
