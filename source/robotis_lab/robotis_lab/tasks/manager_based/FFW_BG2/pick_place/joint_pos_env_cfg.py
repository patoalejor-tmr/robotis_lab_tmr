...
from robotis_lab.tasks.manager_based.FFW_BG2.pick_place.mdp import ffw_bg2_pick_place_events
from robotis_lab.tasks.manager_based.FFW_BG2.pick_place.pick_place_env_cfg import PickPlaceEnvCfg
